...
import ssl
import re
import optparse, random, string, urlparse
import os, sys
import cookielib
...
print("\t	/--------------------------//	")
print("\t	|          devilzXss       ||	")
print("\t	|     By devilzc0de team   ||	")
print("\t	|                          ||	")
print("\t	|       Beta Version       |/ 	")
print("\t	|      devilzc0de.org      /	")
print("\t	 '--------------------------' 	")


print(" These types of URLs are accepted ")
        ...
        try:
            ...
            for payload in heer:
                if payload in mam:
                    found = True
            if found:                
                print ("[+] Confirmed Payload Found in Web Page Code")
                #Getting COKKIES 
